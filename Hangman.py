...
#  короткий список сделан для тестирования. А так лучше взять список из отдельного файла
word_list = ['арбуз', 'яблоко', 'тыква', 'огурец', 'инжир']
...
while again.lower() == 'д' or again.lower() == 'y':
    word = get_word()
    play(word)
